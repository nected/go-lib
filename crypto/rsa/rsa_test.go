...
func setupSuite(t *testing.T) func(t *testing.T) {
	...
	os.Setenv(fmt.Sprintf("%s_%s", config.KEY_ENV_PREFIX, "TESTKEY1_2"), privateKey)
	os.Setenv(fmt.Sprintf("%s_%s", config.KEY_ENV_PREFIX, "TESTKEYR_1"), privateKey)
	...
	return func(t *testing.T) {
		...
		defer os.Unsetenv(fmt.Sprintf("%s_%s", config.KEY_ENV_PREFIX, "TESTKEYR_1"))
...
func TestDecrypt(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				data: "JGFiY2QkZGVmZyRsYWtzamxhc2RqYWxzZGo=", //$abcd$defg$laksjlasdjalsdj
			},
			want: &models.Payload{
		...
		},
		{
			...
			args: args{
				data: "QCRhYmNkJGRlZmckbGFrc2psYXNkamFsc2Rq", //@$abcd$defg$laksjlasdjalsdj
			},
			want: &models.Payload{
		...
		},
		{
			name: "TestEncryptRSA - Conflicting pattern",
			args: args{
				data: "JGFiY2QkMSRsYWtzamxhc2RqYWxzZGo=", //$abcd$1$laksjlasdjalsdj
			},
			want: &models.Payload{
				Data: "JGFiY2QkMSRsYWtzamxhc2RqYWxzZGo=",
			},
			wantErr: false,
		},
	}
